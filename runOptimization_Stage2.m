...
function [results,forcing] = ...
    runOptimization_Stage2(optimization,system,ResDetails,RivDetails)
...
%%  Ipopt
    ...
    if isempty(xFixed)    
        ...
        x_init = xFixed(K*(T_start-2)+(1:T_opt*K));
    end
    ...
    opts.ipopt.constr_viol_tol = 10^2;       
    opts.ipopt.compl_inf_tol = 10^2;
    opts.ipopt.dual_inf_tol = 10^2;
...
for k = 1:T_mov
        ...
        opts.cl = cl;           % constrains lower bounds
